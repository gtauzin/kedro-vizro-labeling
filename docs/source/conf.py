...
# kedro_vizro_labeling documentation build
...
from kedro_vizro_labeling import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_vizro_labeling"
author = "Kedro"
...
htmlhelp_basename = "kedro_vizro_labelingdoc"
...
latex_documents = [
    (
        master_doc,
        "kedro_vizro_labeling.tex",
        "kedro_vizro_labeling Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_vizro_labeling",
        "Project kedro_vizro_labeling codebase.",
        "Data-Science",
    )
]
